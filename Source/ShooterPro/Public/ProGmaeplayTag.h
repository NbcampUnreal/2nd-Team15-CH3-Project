...
namespace ProGameplayTags
{
	...
	SHOOTERPRO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Skill_Grenade);
	SHOOTERPRO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Skill_Dash);
	...
	SHOOTERPRO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(CoolDown_Ability_Grenade);
	...
	SHOOTERPRO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_System_CreateWidget);
