...
UGSCTemplate_GameplayEffectDefinition::UGSCTemplate_GameplayEffectDefinition(): bDenyOverflowApplication(false), bClearStackOnOverflow(false), bSuppressStackingCues(false), StackExpirationPolicy()
{
